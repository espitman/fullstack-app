...
const StickyNav = () => (
  <div className="fixed top-0 left-0 w-full z-50 bg-black/90 backdrop-blur flex items-center justify-between px-8 py-3 shadow transition-all">
    ...
    <ul className="flex gap-8 text-sm font-medium">
      ...
      <li><a href="#" className="hover:text-yellow-400 text-white">Resources</a></li>
      <li>
        <a href="https://github.com/espitman/nerexjs" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 text-white">GitHub</a>
      </li>
    </ul>
  </div>
);
...
const Header = () => {
  ...
  useEffect(() => {
    const onScroll = () => {
      // Show sticky nav after scrolling 120px
